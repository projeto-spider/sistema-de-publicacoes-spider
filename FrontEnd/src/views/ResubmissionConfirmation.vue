...
<div>
    ...
    <div  class="card" 
        style="width: 30rem; top: 30%; left: 33%; z-index: 9999; position: fixed;">
            ...
            <h5 style="text-align: center;">
                ...
                Tem certeza que deseja resubmeter este artigo?
            </h5>
            </span>

            <span class="bg-light" style = "text-align: center;">
                <br>
                <button 
...
export default {
    methods: {
        handleClick(arg) {
            this.$emit('receiveRessubmitionConfirmation', arg)
        }
    }
